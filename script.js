...
document.addEventListener('DOMContentLoaded', function() {
  ...
  link.addEventListener('click', (e) => {
    ...
    // If href is not an anchor, no e.preventDefault() -> browser follows the link normally
  });
});
...
//menu
////////////////////////////////////////////////
//menudocument.addEventListener('DOMContentLoaded', function() {
  // Set current year in footer
  ...
  navLinks.forEach(link => {
    link.addEventListener('click', (e) => {
      ...
      // Skip non-hash links (e.g., /deposit.html)
      if (!targetId.startsWith('#')) {
